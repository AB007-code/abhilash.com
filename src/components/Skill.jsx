...
//   { name: "Ngrok", level: 60, category: "tools" },
// ];
...
const skills = [
  ...
  { name: "OAuth 2.0", level: 75, category: "backend" },

  // Database
  { name: "MongoDB", level: 85, category: "backend" },
  { name: "PostgreSQL", level: 80, category: "backend" },
  { name: "Prisma ORM", level: 80, category: "backend" },
  { name: "Firebase Firestore", level: 75, category: "backend" },
  { name: "SQL", level: 80, category: "backend" },

  // AI / Automation
  { name: "Generative AI (Gemini API)", level: 80, category: "tools" },
  { name: "Vapi (Voice AI)", level: 75, category: "tools" },
  { name: "N8N Automation", level: 85, category: "tools" },
  { name: "Playwright (Scraping)", level: 85, category: "tools" },
  { name: "Selenium (Scraping)", level: 80, category: "tools" },
  ...
  { name: "Ngrok", level: 75, category: "tools" },
  { name: "VS Code", level: 95, category: "tools" },
];
